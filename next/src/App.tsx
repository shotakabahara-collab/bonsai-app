    ...
    <div className="app-shell" data-testid="app-shell">
      ...
      {careMode === 'deadwood' && (
        <DeadwoodLifecycleSheet
          ...
          onPause={projectId => commit(current => pauseDeadwoodProjectInGame(current, projectId), '神・舎利の工程を中断しました')}
          onResume={projectId => commit(current => resumeDeadwoodProjectInGame(current, projectId), '神・舎利の工程を再開しました')}
        />
      )}
