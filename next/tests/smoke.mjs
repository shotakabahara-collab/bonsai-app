...
const report = { phase: 'launch', pageErrors: [], consoleErrors: [], migrated: null, afterPrune: null };
...
try {
  ...
  try { await page.screenshot({ path: 'test-artifacts/iphone-failure.png', fullPage: true }); } catch {}
  throw error;
} finally {
